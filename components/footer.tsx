        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div>
            ...
            <p className="text-background/80 mb-6 leading-relaxed">
              Building dreams into reality with exceptional real estate developments in Ranchi and beyond.
            </p>
          ...
          <div>
            <h3 className="text-xl font-bold mb-6 text-white">Our Projects</h3>
            <ul className="space-y-3">
              <li>
                <Link
                  href="/projects/riya-heights"
                  className="text-background/80 hover:text-primary transition-colors duration-300 inline-block hover:translate-x-1"
                >
                  Riya Heights
                </Link>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-background/80">Flat 404D, Riya Plaza, Kokar, Ranchi</span>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="h-5 w-5 text-primary flex-shrink-0" />
                <a href="tel:+919523735343" className="text-background/80 hover:text-primary transition-colors">
                  +91 95237 35343
                </a>
              </li>
              <li className="flex items-center gap-3">
